        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Tatry Home</span>
            </div>
            <p className="text-gray-300 mb-4">
              Your cozy mountain retreat in the heart of Tatra Mountains.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-tatryhome-300 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#guest-stories" className="text-gray-300 hover:text-white transition-colors">{t('nav.guestStories')}</a></li>
